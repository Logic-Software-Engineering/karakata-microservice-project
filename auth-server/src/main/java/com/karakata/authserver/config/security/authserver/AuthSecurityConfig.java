package com.karakata.authserver.config.security.authserver;

import com.karakata.authserver.config.userdetail.authprovider.CustomAuthenticationProvider;
...
public class AuthSecurityConfig {
    ...
    @Autowired
    public void bindAuthenticationProviderToAuthManagerBuilder(AuthenticationManagerBuilder authenticationManagerBuilder) {
        authenticationManagerBuilder.authenticationProvider(customAuthenticationProvider);
    }

    @Bean
    public JWKSetSource<SecurityContext> jwkSetSource() throws NoSuchAlgorithmException {
