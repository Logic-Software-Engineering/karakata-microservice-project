...
public class AdminNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseBody
    @ExceptionHandler(AdminNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> adminNotFoundException(AdminNotFoundException anfe,
                                                                       WebRequest request){
